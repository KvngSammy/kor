    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="fixed top-0 w-full bg-white/80 backdrop-blur-md border-b border-gray-100 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-bold text-lg text-navy-900 leading-tight">Kor</h1>
      ...
      <footer className="bg-navy-950 text-gray-400 py-12 px-6">
        <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="font-bold text-white">Kor Nigeria</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto mt-12 pt-8 border-t border-gray-800 text-sm text-center">
          © 2024 Kor Nigeria. All rights reserved. Powered by Paystack, Monnify & Flutterwave.
        </div>
      </footer>
    </div>
  );
